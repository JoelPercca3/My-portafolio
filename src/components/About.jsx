...
const About = () => {
  return (
    <section className="bg-gradient-to-br from-gray-800 via-gray-900 to-black py-12 text-gray-300">
      <div className="container mx-auto px-6 md:px-12">
        <h2 className="text-4xl font-extrabold mb-6 text-white border-b-4 border-blue-500 inline-block pb-2">
          About Me
        </h2>
        <p className="leading-relaxed text-lg md:text-xl mb-6">
