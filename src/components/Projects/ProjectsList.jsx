  ...
  const projects = [
    {
      ...
      image: '/assets/images/weather.JPG'  // Corregido
    },
    {
      title: 'Ecommerce app',
      ...
      image: '/assets/images/ecommerce.JPG'  // Corregido
    },
    {
      title: 'Winbnb app',
      ...
      image: '/assets/images/tiendaLocation.JPG'  // Corregido
    },
    {
      title: 'Space app',
      description: 'A web application inspired by Airbnb to look for different flats by location and guests.',
      ...
      image: '/assets/images/spaceApp.JPG'  // Corregido
    },
    {
      ...
      repoLink: 'https://github.com/JoelPercca3/PracticaCalificada3.git',
      image: '/assets/images/login.JPG',  // Corregido
      frontend: {
